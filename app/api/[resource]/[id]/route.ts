...
export const PUT = withAuthAndAnalytics(handlePUT);
export const PATCH = withAuthAndAnalytics(handlePATCH);
export const DELETE = withAuthAndAnalytics(handleDELETE);